...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  const { scrollYProgress } = useScroll({
    target: containerRef,
    offset: isMobile ? ["start 10%", "end 50%"] : ["start 10%", "end 80%"],
  });
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 flex flex-col justify-center items-center">
      ...
      <div ref={ref} className="relative max-w-5xl mx-auto pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex pt-0 md:pt-40 md:gap-1 justify-center"
          >
            <div className="relative pl-20 pr-4 md:pl-4 w-200">
