    ...
    <div className={`
      ...
      <div className={`hidden xl:block duration-500 transition-all ${items ? '-translate-y-20': 'translate-y-0'}`}>
        ...
        flex flex-rows gap-3 items-center justify-center">
          <Link to="home" activeClass='text-white scale-120 font-bold' spy={true} smooth={true} className=' hover:scale-110 hover:font-bold border-1 hover:mx-2 rounded-2xl px-3 border-white/10 cursor-pointer transition-all duration-200 ease-in-ou'>Home</Link>
